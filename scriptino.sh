...
rpm-ostree install ddcutil tailscale --apply-live
...
sudo nmcli connection modify enp39s0 ipv6.method disabled
sudo nmcli connection modify enp39s0 connection.dns-over-tls yes
